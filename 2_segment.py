...
def segment(path_list, gpu_id, kernel_size, data_dir, out_dir):
    ...
    save_dir = os.path.join(out_dir, "gaussian_{}".format(kernel_size))
...
def main():
    ...
    segment(args.config_file, args.gpu_id, args.kernel_size, args.data_path, args.out_dir)


if __name__ == '__main__':
    segment("home/christer/Datasets/MCF7/structured/metadata/DAPI_paths.pkl",
            "0", 3,
            "/home/christer/Datasets/MCF7/raw_extracted",
            "/home/christer/Datasets/MCF7/structured/segmentations")
